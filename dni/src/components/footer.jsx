...
const Footer =()=>{
    return(
        <div className="p-[50px] bg-black flex flex-col lg:flex-row">
            <div className="text-white w-[30%]">
                <h1 className="text-[20px] border-l-[3px] border-[#dc143c] pl-[10px]">KONTAKT</h1>
            ...
            <div className="text-white w-[30%]">
                <h1 className="text-[20px] border-l-[3px] border-[#dc143c] pl-[10px]">ARCHIWUM</h1>
                <p>marzec 2023<br/>
                luty 2023<br/>
                styczeń 2023</p>
            </div>
            <div className="text-white">
                <h1 className="text-[20px] border-l-[3px] border-[#dc143c] pl-[10px]">MAPA</h1>
                <iframe
				title="yo"
